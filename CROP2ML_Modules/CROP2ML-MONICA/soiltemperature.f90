MODULE Soiltemperaturemod_MONICA
    IMPLICIT NONE
CONTAINS
    ...
    SUBROUTINE model_soiltemperature_monica(noOfSoilLayers, &
        noOfTempLayers, &
        noOfTempLayersPlus1, &
        soilSurfaceTemperature, &
        timeStep, &
        ...
        REAL , DIMENSION(:), INTENT(INOUT) :: saturation
        REAL , DIMENSION(:), INTENT(INOUT) :: soilOrganicMatter
        REAL , DIMENSION(:), INTENT(INOUT) :: soilTemperature
        REAL , DIMENSION(:), INTENT(INOUT) :: V
        REAL , DIMENSION(:), INTENT(INOUT) :: B
        ...
        REAL , DIMENSION(:), INTENT(INOUT) :: matrixSecondaryDiagonal
    ...
    END SUBROUTINE model_soiltemperature_monica
