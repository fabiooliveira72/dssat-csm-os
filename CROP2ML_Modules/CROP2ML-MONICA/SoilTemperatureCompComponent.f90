...
SUBROUTINE model_soiltemperaturecomp(tmin, &
    ...
    REAL, INTENT(INOUT) :: globrad
    REAL, INTENT(INOUT) :: dampingFactor
    REAL, INTENT(INOUT) :: soilCoverage
    REAL, INTENT(INOUT) :: soilSurfaceTemperatureBelowSnow
    LOGICAL, INTENT(IN) :: hasSnowCover
    REAL, INTENT(IN) :: timeStep
    REAL , DIMENSION(:), INTENT(INOUT) :: soilMoistureConst
    ...
    REAL , DIMENSION(:), INTENT(INOUT) :: layerThickness
    REAL , DIMENSION(:), INTENT(INOUT) :: soilBulkDensity
    REAL , DIMENSION(:), INTENT(INOUT) :: saturation
    REAL , DIMENSION(:), INTENT(INOUT) :: soilOrganicMatter
    REAL , DIMENSION(:), INTENT(INOUT) :: V
    REAL , DIMENSION(:), INTENT(INOUT) :: B
    REAL , DIMENSION(:), INTENT(INOUT) :: volumeMatrix
    REAL , DIMENSION(:), INTENT(INOUT) :: volumeMatrixOld
    REAL , DIMENSION(:), INTENT(INOUT) :: matrixPrimaryDiagonal
    REAL , DIMENSION(:), INTENT(INOUT) ::  &
            matrixSecondaryDiagonal
    REAL , DIMENSION(:), INTENT(INOUT) :: heatConductivity
    REAL , DIMENSION(:), INTENT(INOUT) :: heatConductivityMean
    REAL , DIMENSION(:), INTENT(INOUT) :: heatCapacity
    REAL , DIMENSION(:), INTENT(INOUT) :: solution
    REAL , DIMENSION(:), INTENT(INOUT) :: matrixDiagonal
    REAL , DIMENSION(:), INTENT(INOUT) :: matrixLowerTriangle
    REAL , DIMENSION(:), INTENT(INOUT) :: heatFlow
...
!                          ** unit : °C
    ...
    call model_soiltemperature_monica(noOfSoilLayers, noOfTempLayers,  &
