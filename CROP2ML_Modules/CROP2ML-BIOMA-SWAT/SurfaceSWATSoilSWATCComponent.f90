MODULE Surfaceswatsoilswatcmod_SW
    USE Surfacetemperatureswatmod_SW
    USE Soiltemperatureswatmod_SW
    IMPLICIT NONE
CONTAINS

    SUBROUTINE model_surfaceswatsoilswatc_SW(AirTemperatureMaximum, &
    ...
    !                          ** min : -60
    !                          ** unit : degC
        call model_surfacetemperatureswat_SW(GlobalSolarRadiation,  &
