MODULE Soiltemperatureswatmod_SW
    IMPLICIT NONE
CONTAINS

    SUBROUTINE init_soiltemperatureswat_SW(VolumetricWaterContent, &
        LayerThickness, &
        LagCoefficient, &
        ...
        END DO
    END SUBROUTINE init_soiltemperatureswat_SW

    SUBROUTINE model_soiltemperatureswat_SW(VolumetricWaterContent, &
        ...
        DO i = 1 , SIZE(LayerThickness)-1, 1
            ...
            SoilTemperatureByLayers(i+1) = LagCoefficient *  &
                    ...
                    * (AirTemperatureAnnualAverage - SurfaceSoilTemperature) +  &
                    SurfaceSoilTemperature))
        END DO
    END SUBROUTINE model_soiltemperatureswat_SW
