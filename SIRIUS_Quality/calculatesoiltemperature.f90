...
CONTAINS
    ...
    REAL FUNCTION SoilTempB(weatherMinTemp, &
    ...
    REAL FUNCTION SoilTempA(weatherMaxTemp, &
        weatherMeanTemp, &
        soilHeatFlux, &
    ...
    REAL FUNCTION SoilMinimumTemperature(weatherMaxTemp, &
        weatherMeanTemp, &
        weatherMinTemp, &
        soilHeatFlux, &
        lambda_, &
    ...
    REAL FUNCTION SoilMaximumTemperature(weatherMaxTemp, &
        weatherMeanTemp, &
        weatherMinTemp, &
        soilHeatFlux, &
        lambda_, &
    ...
    REAL FUNCTION UpdateTemperature(minSoilTemp, &
        maxSoilTemp, &
        ...
        Temperature = (9.0 * Temp + meanTemp) / 10.0
